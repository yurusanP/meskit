...
import org.yurusanp.meskit.parser.SemGuSParser.StartContext
...
fun String.parse(): StartContext = let {
...
fun <R> String.solve(solver: SemGuSVisitor<R>): R = let { line ->
  solver.visit(line.parse())
}
